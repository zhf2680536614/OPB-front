...
import { Calendar, Guide, Trophy, Timer, Star, Present } from '@element-plus/icons-vue'
    ...
    <div class="action-container">
        ...
        <el-card class="check-in-card">
            ...
            <div class="check-in-content">
                ...
                <el-button type="success" :disabled="todayChecked" @click="checkIn" class="check-in-btn">
        ...
        <el-card class="guide-card">
            ...
            <div class="guide-content">
                <el-collapse>
                    <el-collapse-item v-for="(guide, index) in guides" :key="index" :title="guide.title">
                        <ul class="guide-list">
        ...
        <el-card class="achievement-card">
            ...
            <div class="achievement-content">
                <div v-for="(achievement, index) in achievements" :key="index" class="achievement-item">
                    ...
                    <el-progress :percentage="(totalPoints / achievement.points) * 100"
